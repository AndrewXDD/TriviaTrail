  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ProfileRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProfileRow> profileMainProfileRowList = snapshot.data!;
        final profileMainProfileRow = profileMainProfileRowList.isNotEmpty
            ? profileMainProfileRowList.first
            : null;
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              valueOrDefault<String>(
                                                profileMainProfileRow?.fullName,
                                                'error',
                                              ),
                                              style:
