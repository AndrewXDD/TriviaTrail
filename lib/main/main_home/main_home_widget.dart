  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ProfileRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProfileRow> mainHomeProfileRowList = snapshot.data!;
        final mainHomeProfileRow = mainHomeProfileRowList.isNotEmpty
            ? mainHomeProfileRowList.first
            : null;
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamed('main_friends_list');
                                    },
                                              ...
                                              child: Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        10.0, 0.0, 0.0, 0.0),
                                                child: Text(
                                                  '[Topic of Quizz ] - [Number of Question]',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium,
                                                ),
