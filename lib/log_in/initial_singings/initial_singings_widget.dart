...
export 'initial_singings_model.dart';

class InitialSingingsWidget extends StatefulWidget {
  const InitialSingingsWidget({super.key});

  @override
  State<InitialSingingsWidget> createState() => _InitialSingingsWidgetState();
}

class _InitialSingingsWidgetState extends State<InitialSingingsWidget> {
  late InitialSingingsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InitialSingingsModel());
  }
